...
function IconRifas() {
  return (
    <svg viewBox="0 0 24 24" fill="none" className="adminpro-nav-icon">
      <path d="M3 9.5A2.5 2.5 0 0 0 5.5 7H18.5A2.5 2.5 0 0 0 21 9.5v5A2.5 2.5 0 0 0 18.5 17H5.5A2.5 2.5 0 0 0 3 14.5v-5Z" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
...
function IconGanador() {
  return (
    <svg viewBox="0 0 24 24" fill="none" className="adminpro-nav-icon">
      ...
      <path d="M8 6H5a2 2 0 0 0 2 2h1M16 6h3a2 2 0 0 1-2 2h-1M12 11v4M9 20h6M10 15h4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function IconGanadores() {
  return (
    <svg viewBox="0 0 24 24" fill="none" className="adminpro-nav-icon">
      <path d="M12 3l2.35 4.76 5.25.76-3.8 3.7.9 5.23L12 15l-4.7 2.45.9-5.23-3.8-3.7 5.25-.76L12 3Z" stroke="currentColor" strokeWidth="1.7" strokeLinejoin="round" />
...
function IconRanking() {
  return (
    <svg viewBox="0 0 24 24" fill="none" className="adminpro-nav-icon">
      <path d="M4 19V10M12 19V5M20 19v-8" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
...
function IconCompras() {
  return (
    <svg viewBox="0 0 24 24" fill="none" className="adminpro-nav-icon">
      <path d="M6 7h15l-1.5 7.5a2 2 0 0 1-2 1.5H9a2 2 0 0 1-2-1.5L5 4H2" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
...
function IconLogout() {
  return (
    <svg viewBox="0 0 24 24" fill="none" className="adminpro-nav-icon">
      ...
      <path d="M10 4H6a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function IconBrand() {
  return (
    <svg viewBox="0 0 24 24" fill="none" className="adminpro-brand-svg">
      ...
      <path d="M8 9h8M8 15h8M9 5v14M15 5v14" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
    </svg>
  );
}
...
export default function Sidebar({ activa, onNavigate, onLogout, adminEmail }) {
  ...
  const nombreVisible = adminEmail?.split("@")[0]?.replace(/[._-]/g, " ") || "Administrador";
  ...
  const NavButtons = ({ mobile = false }) => (
    <nav className={mobile ? "adminpro-mobile-nav" : "adminpro-nav"}>
      {items.map((item) => (
        <button
          key={item.id}
  ...
  const UserCard = () => (
    <div className="adminpro-user-card adminpro-user-card-bottom">
      ...
      <button className="adminpro-user-logout-icon" onClick={onLogout} type="button" title="Cerrar sesión">
        <IconLogout />
      </button>
    </div>
  );
    ...
    <>
      <div className="adminpro-mobile-topbar">
        <div className="adminpro-mobile-topbar-brand">
          <div className="adminpro-brand-icon"><IconBrand /></div>
          <div><strong>RIFAPRO</strong><small>ADMIN PANEL</small></div>
        </div>
        <button
          type="button"
      ...
      {mobileMenuOpen && (
        <div className="adminpro-mobile-overlay" onClick={() => setMobileMenuOpen(false)}>
          <div className="adminpro-mobile-drawer" onClick={(e) => e.stopPropagation()}>
            <div className="adminpro-mobile-drawer-head">
              <div className="adminpro-mobile-topbar-brand">
                <div className="adminpro-brand-icon"><IconBrand /></div>
                <div><strong>RIFAPRO</strong><small>ADMIN PANEL</small></div>
              </div>
              <button type="button" className="adminpro-mobile-close-btn" onClick={() => setMobileMenuOpen(false)}>✕</button>
            </div>
            <NavButtons mobile />
            <UserCard />
          </div>
      ...
      <aside className="adminpro-sidebar">
        <div className="adminpro-brand">
          <div className="adminpro-brand-icon"><IconBrand /></div>
          <div><h2>RIFAPRO</h2><p>ADMIN PANEL</p></div>
        </div>
        <NavButtons />
        <UserCard />
      </aside>
